    ...
    >
      ...
      >
        ...
        <div className="text-sm">
          <p className="text-[16px] font-medium text-[var(--text-color)] max-[400px]:text-[14px]">
            Start from
          </p>
          <div className="flex gap-2 items-center text-[16px] text-[var(--text-color)] max-[400px]:text-[14px]">
            <CiClock1 />
      ...
      <div className="flex flex-col gap-2 text-sm text-[var(--text-color)] w-full">
        <p className="font-bold text-[20px] text-[var(--text-color)]max-[400px]:text-[16px]">
          {task.title}
        </p>
      ...
      <div className="w-full sm:w-[160px]">
        <span className="text-[18px] font-bold text-[var(--text-color)] mb-1 block max-[400px]:text-[16px]">
